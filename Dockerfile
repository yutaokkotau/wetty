...
# Start tmate and write session details to both index.html and the logs
...
# Start Nginx in the foreground and run keep-alive to ensure the container stays alive
